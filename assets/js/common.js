$("a").on("click", function (e) {
    ...
    var id_symbol = "#";
    var concat = " img";
    //add a class called example-menu-selected to img in anchor tag which will display the glowed img instead of normal one
    //document.write(id_symbol.concat(elementId.concat(concat)));
    switch (elementId) 
    {
